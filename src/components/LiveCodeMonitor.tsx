...
export const LiveCodeMonitor: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-95 min-w-95 max-w-95 shrink-0">
      ...
      <div className="w-[380px] min-w-[380px] max-w-95 h-57.5 min-h-57.5 max-h-57.5 bg-slate-950/80 backdrop-blur-xl border border-slate-700/60 rounded-xl shadow-2xl shadow-indigo-950/60 overflow-hidden relative flex flex-col justify-between group">
